...
export function Navbar() {
  ...
  return (
    <>
      <nav className="relative border-b border-[#E4E4E7] bg-white px-4 py-3 flex items-center justify-between sticky top-0 z-40">
        {/* Logo + Brand */}
        <div
        ...
        {/* Mobile menu — absolute inside the sticky nav so it overlays the
            page instead of displacing it. `top-full` tracks the nav's real
            height rather than hardcoding it. */}
        {mobileOpen && (
          <div
            id="mobile-nav"
            className="md:hidden absolute top-full left-0 right-0 bg-white border-b border-[#E4E4E7] shadow-lg"
          >
      ...
      {/* Scrim: tapping anywhere off the menu closes it. */}
      {mobileOpen && (
        <div
          className="md:hidden fixed inset-0 top-[57px] z-30 bg-black/20"
